...
function checkemail(email)
{
    ...
    {   
        ...
        document.getElementById('email_error').innerText='email length must be 8 character'
    }
}
function checkpassword(password)
{
    ...
    {   
        ...
        document.getElementById('password_error').innerText='password must be 8 letter long and inculde dot operator'
    }
}
